        ...
        <View style={styles.modalContent}>
          ...
          {availableSections.length > 0 && (
            <View style={styles.filterSection}>
              ...
              >
                <Text style={styles.sortOptionText}>All Sections</Text>
                {!selectedSection && (
                  <Ionicons name="checkmark" size={18} color="#00a550" />
                )}
              </TouchableOpacity>
              {availableSections.map((section) => (
                ...
                >
                  <Text style={styles.sortOptionText}>{section}</Text>
